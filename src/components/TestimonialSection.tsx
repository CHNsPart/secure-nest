    ...
    <div className="relative container w-full bg-white py-6 sm:py-8 lg:py-16">
      <div className="mx-auto max-w-screen-xl">
        ...
        >
          {!loading ?
            <>
              {data.map(({id, quote, image, author, role}) => (
                <div key={id} className="flex flex-col items-center gap-4 rounded-lg bg-gradient-to-br from-green-500 to-green-800 min-w-96 px-8 py-6 md:gap-6">

  ...
  return (
    <div className="container flex flex-col justify-center items-center h-screen w-full">
        <div className='flex flex-col justify-center items-center gap-2'>
          ...
          <span className='text-gray-500 text-center w-1/2 mb-2'>We will contact you soon to schedule the installation. Please note that your bill cycle will start on the date of the installation.</span>
          ...
          <Link href="/profile">
              <Button className='bg-green-500 hover:bg-green-600'>Done</Button>
          </Link>
        </div>
    </div>
  )

    ...
    <main className="h-full w-full flex flex-col gap-4 justify-center items-start">
        ...
        <div className="container w-full mx-auto flex px-5 py-10 md:py-24 md:flex-col flex-col items-center">
          <div className="lg:flex-grow flex flex-col md:items-center md:text-center mb-16 items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">
              Build your smart home with a Local
              <br />
              Canadian security provider
            </h1>
            <p className="mb-8 w-full md:w-1/2 leading-relaxed">
              Choose from our selection of home security and automation plans.
              Add or remove devices to{" "}
            ...
            <div className="flex justify-center">
              <RegisterLink>
                <Button className="text-white bg-green-600 border-0 py-2 px-6 focus:outline-none hover:bg-green-700 rounded">
                  Register
                </Button>
              </RegisterLink>
              <Link href="/plans">
                <Button className="ml-4 text-gray-700 bg-gray-100 border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded">
                  Plans
                </Button>
              </Link>
            </div>
      ...
      <div className="w-full bg-gray-100 py-16">
        <div className="container w-full flex flex-col md:flex-row items-center gap-5">
          ...
          />
          <p className="w-fit">
            SecureNest is a leading local Canadian home security company serving
            the Greater Toronto Area (GTA) and beyond. With a commitment to
            innovation and personalized service, SecureNest offers
            state-of-the-art security technology, including smart home
            integration, Self-monitoring, HD video surveillance, and smart
            sensors. Their customized security solutions cater to the unique
            needs of each client, ensuring peace of mind and protection for
            families and homes. SecureNest is deeply invested in community
            engagement, actively participating in outreach programs and
            partnerships to make neighbourhoods safer. With SecureNest,
            homeowners can trust in a reliable and community-centric approach to
            home security.
          </p>
        </div>
      </div>
